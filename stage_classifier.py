...
class Classifier(object):
    ...
    def __add__(c1, c2):
        from stage_language import identity, drop, forward, DataFctPolicy
        def _cross(r1, r2):
            """
    ...
    def __rshift__(c1, c2):
        from stage_language import identity, DataFctPolicy, DynamicPolicy, modify, forward, tag, NetworkFunction
        from stage_language import drop, match
