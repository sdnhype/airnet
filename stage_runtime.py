...
#log = core.getLogger()
log = logging.getLogger("stage_runtime")
...
class Runtime():
    ...
    def get_corresponding_match_switch_list(self, fabric, flow_src, label, classifiers):
        ...
        :param label:
        """
        from stage_language import modify 
    ...
    def enforce_fabric_policies(self, fabric, classifiers):
        ...
        def get_edge_destination(actions):
            ...
            """            
            from stage_language import carry
            for act in actions:
    ...
    def install_diff_lists(self, diff_lists):
        ...
        _enforce_diffList_duration = int(round(time.time() * 1000)) - _enforcing_duration 
